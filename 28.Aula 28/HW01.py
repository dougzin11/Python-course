...
print(f'Foram computados {len(resultados)} votos')

print('Jogador          Votos          %')
for jogador in range(1, 24):
    if resultados.count(jogador) != 0:
        print(jogador,f'    {resultados.count(jogador)}',f'    {resultados.count(jogador) / len(resultados) * 100}')
